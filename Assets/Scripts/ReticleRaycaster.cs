//Reticle Raycaster Class
//Casts Ray from any reticle on canvas

//@author Adrian Ramcharitar
...
public class ReticleRaycaster : MonoBehaviour{
    ...
    //[SerializeField] private Reticle2 m_Reticle;
    ...
    */
        ...
        if (m_ShowDebugRay) {
            ...
            //This is where it draws the ray
            Debug.DrawRay(Camera.main.gameObject.transform.position, direction * m_DebugRayLength, Color.blue, m_DebugRayDuration);
        }
