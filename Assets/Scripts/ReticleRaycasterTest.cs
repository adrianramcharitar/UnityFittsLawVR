...
namespace VRStandardAssets.Utils {
    ...
    public class ReticleRaycasterTest : MonoBehaviour {
        public event Action<RaycastHit> OnRaycasthit;                   // This event is called every frame that the user's gaze is over a collider.


        [SerializeField] private Transform m_Camera;
        [SerializeField] private LayerMask m_ExclusionLayers;           // Layers to exclude from the raycast.
        [SerializeField] private Reticle2 m_Reticle2;                    // The reticle, if applicable.
        ...
        private void ReticleRaycast() {
            ...
            if (m_ShowDebugRay) {
              //  Debug.DrawRay(m_Camera.position, direction * m_DebugRayLength, Color.blue, m_DebugRayDuration);
            }

            // Create a ray that points forwards from the camera.
            Ray ray = new Ray(m_Camera.position, direction);
            RaycastHit hit;
