...
namespace VRStandardAssets.Utils
{
    ...
    public class VRInput : MonoBehaviour
    {
        ...
        [SerializeField] private float triggerPressDepth = 0.5f;
        ...
        private void CheckInput()
        {
            ...
            //trigger press for Oculus Touch
            if (OVRInput.Get(OVRInput.Axis1D.SecondaryIndexTrigger) > triggerPressDepth) {
