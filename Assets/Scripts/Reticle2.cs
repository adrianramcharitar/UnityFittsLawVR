...
namespace VRStandardAssets.Utils {
    ...
    public class Reticle2 : MonoBehaviour {
        ...
        [SerializeField] private Transform m_Reticle2Transform;      // We need to affect the reticle's transform.
        ...
        public Transform ReticleTransform { get { return m_Reticle2Transform; } }


        private void Awake() {
            // Store the original scale and rotation.
            m_OriginalScale = m_Reticle2Transform.localScale;
            m_OriginalRotation = m_Reticle2Transform.localRotation;
        ...
        public void SetPosition() {
            ...
            m_Reticle2Transform.position = m_Camera.position + m_Camera.forward * m_DefaultDistance;

            // Set the scale based on the original and the distance from the camera.
            m_Reticle2Transform.localScale = m_OriginalScale * m_DefaultDistance;

            // The rotation should just be the default.
            m_Reticle2Transform.localRotation = m_OriginalRotation;
        }


        // This overload of SetPosition is used when the VREyeRaycaster has hit something.
        public void SetPosition(RaycastHit hit) {
            m_Reticle2Transform.position = hit.point;
            m_Reticle2Transform.localScale = m_OriginalScale * hit.distance;

            // If the reticle should use the normal of what has been hit...
            if (m_UseNormal)
                // ... set it's rotation based on it's forward vector facing along the normal.
                m_Reticle2Transform.rotation = Quaternion.FromToRotation(Vector3.forward, hit.normal);
            else
